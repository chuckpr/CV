...
\begin{itemize}
    ...
    \item \textbf{Teaching Fellow - Microbial
        Diversity Course}, Marine Biological Laboratory (Woods Hole, MA) (2010-2014)
\end{itemize}
...
\item Pepe-Ranney C and Hall EK. \textbf{The effect of carbon subsidies on
    ...
    \href{http://journal.frontiersin.org/article/10.3389/fmicb.2015.00703/abstract}
    {link}\\
    Code for sequence analysis and manuscript figures can be found here: \\
...
\item Pepe-Ranney C$^{*}$, Campbell A$^{*}$, Koechli C, Berthrong S, 
    ...
    Submitted to \textit{Nature Microbiology}. Preprint: \href{http://dx.doi.org/10.1101/022483}{http://dx.doi.org/10.1101/022483}\\
...
\item Pepe-Ranney C, Campbell A, Buckley DH. 
    ...
    Code for current analyses can be found here:\\
...
\item Hahn C, Hall EK, Pepe-Ranney C, Oyler-McCance S.
    ...
    Current analyses and figures can be found here:\\
